        ...
        <div className='bg-white rounded-xl h-32 w-1/3 mr-6 mt-8 mb-12 flex flex-col'>
            ...
            <div className="flex flex-row justify-between mx-4 ">
                <p className=" text-md text-slate-700">
                    Level <span className='bg-primary rounded-md text-white px-2 pb-1 text-center'>0</span> Contributor
                </p>
                <p className="font-normal text-md text-slate-600">50 points to level 1</p>
    ...
    <div className='bg-white w-full h-full pl-20 pr-10 pt-5 pb-20'>
        ...
        <div className="flex flex-row justify-between items-center w-full mt-4 pr-10">
            ...
            <div className="border border-slate-200 flex flex-col w-2/5">
                <div className="text-slate-400 m-2 flex flex-row mt-3 gap-2 text-lg"> <span className='mt-1'><Trophy fill="var(--yellow)" width="20" height="20"/></span> Points </div>
            ...
            <div className="text-slate-400 m-2 flex flex-row mt-3 gap-2 text-lg"> <span className='mt-1'><Heart fill="var(--error)" width="20" height="20"/></span> Impact </div>                <div className="h-0 border-t border-slate-200 text-2xl text-center"></div>
                <div className="flex flex-row mx-3 gap-4 items-center my-2">
                    <div className="flex flex-col items-center">
                        <p className="font-bold text-lg text-slate-600">0</p>
                        <p className="text-slate-400 text-sm font-normal">students helped</p>
                    </div>                  
                </div>
            </div>
        ...
        <div className="text-center text-sm text-slate-600 mt-10 flex flex-row justify-center gap-2"> 
                    <span className='mt-3'><Info fill="var(--gray)" width="20" height="20"/></span> 
                    <p className='mt-3'>You have until the end of December to upload and earn points for the January lottery!</p>
                    <DaButton 
                        label={'Upload Documents'} 
                        className='text-white bg-primary font-semibold text-lg ml-2' 
                        fullRounded
                        startIcon={<span className='mt-1'> <Upload fill="var(--white)" width="20" height="20"/> </span> }
                    />
        </div>
